...
R8-A-F11 is the locally complete Color Inspector professional-vocabulary refinement at `0.1.2.0013`. It increments
...
```text
InformationalVersion = 0.1.2.0013
AssemblyVersion      = 0.1.2.13
FileVersion          = 0.1.2.13
```
