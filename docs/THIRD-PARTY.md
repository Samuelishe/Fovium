...
| libheif | struktur AG / libheif contributors | LGPL-3.0-or-later library | Decode-only HEIF/AVIF native-runtime prerequisite artifact | [Repository](https://github.com/strukturag/libheif), [release](https://github.com/strukturag/libheif/releases/tag/v1.23.1) | `1.23.1`, commit `2c4bbb54c2738d4a5efbbe3e5fa1d5d76bb88eb0` | Native source-build input introduced in R7-C-N1; not yet a Fovium production dependency. Plugin loading, all encoders, examples/CLIs, and unrelated codecs are disabled; exact archive/binary hashes and per-RID inventory are owned by `eng/native/libheif/versions.json` and artifact manifests |
| libde265 | struktur AG / libde265 contributors | LGPL-3.0-or-later | HEVC decoder for the decode-only libheif prerequisite | [Repository](https://github.com/strukturag/libde265), [release](https://github.com/strukturag/libde265/releases/tag/v1.1.1) | `1.1.1`, commit `4dd701fffac01632ffd5cabc5ef10deb56accba1` | Native source-build input introduced in R7-C-N1; built as an app-local shared decoder library, with encoder and CLI targets disabled; not yet referenced by production Fovium |
| dav1d | VideoLAN / dav1d contributors | BSD-2-Clause | AV1 decoder for the decode-only libheif prerequisite | [Official source](https://code.videolan.org/videolan/dav1d), [release archive](https://download.videolan.org/pub/videolan/dav1d/1.5.4/) | `1.5.4`, commit `191bdda98ec3c68137754dc97da1db34043d7cd4` | Native source-build input introduced in R7-C-N1; tools/examples/tests are disabled and only the app-local shared decoder library is packaged; not yet referenced by production Fovium |
