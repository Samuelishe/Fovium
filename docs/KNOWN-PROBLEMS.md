...
| Presenter overlay runtime evidence is one Windows 100% display | Pure geometry and raster tests cover transform/clipping, while local smoke covers mouse tools, fullscreen, Peek/Blink, focus loss, and persistence; fractional DPI and other platforms may differ in pointer/cursor feel | Exercise real 125/150/200% Windows and Linux/macOS runtimes before claiming identical presenter interaction |
