...
R8-B-W1 is locally complete at `0.1.0.0008` and ready for owner/hosted verification. On ordinary Windows SDR output, enabled-by-default photograph-only Monitor Color Management resolves the active display through the real viewer HWND, admits the assigned bounded RGB display ICC, and creates a viewport-sized reference-sRGB → monitor-device RGB presentation through app-local Little CMS 2.19. Advanced Color/HDR, invalid/unavailable profiles, unsupported source meaning, and missing native runtime retain the existing presentation recoverably. Color Picker remains reference sRGB and Histogram remains source-domain. R8-B-P1 is accepted at `932c1285394d6bfa6c10cc75c1810c882eef7c6c`; the test correction is accepted at `90d733254790d152cc5d298f39c23e2b8171b249`; R8-B-N1 is accepted at `5155b7806703a657d89ab2923fd2936814a37a16` with green normal and native hosted matrices.
...
- Windows ordinary-SDR photograph presentation through the assigned active-monitor RGB ICC and app-local Little CMS 2.19, with viewport-bounded overscanned pixels, transient same-source/same-destination geometry proxies, exact-refinement latest-wins/coalescing, explicit fallback state, and no monitor transform of Stage, Matte, Ambient, markup, Color Picker, or Histogram.
