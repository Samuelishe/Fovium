...
- Windows ordinary-SDR photograph presentation through the assigned active-monitor RGB ICC and app-local Little CMS 2.19, with viewport-bounded derived pixels, exact source identity, latest-wins/coalescing, explicit fallback state, and no monitor transform of Stage, Matte, Ambient, markup, Color Picker, or Histogram.
