...
internal sealed class PhotoMetadataCache(int capacity = PhotoMetadataCache.DefaultCapacity)
{
    public const int DefaultCapacity = 192;
    ...
    public bool TryGet(long imageIdentity, out PhotoMetadataReadResult? result)
    {
    ...
    public void Add(long imageIdentity, PhotoMetadataReadResult result)
    {
    ...
    private sealed record Entry(long ImageIdentity, PhotoMetadataReadResult Result);
}
