...
internal static class ProfessionalShadeCatalog
{
    ...
    [
        ...
        Define("professional-apple-green", ProfessionalColorTerm.AppleGreen,
            UiStrings.ColorPickerProfessionalAppleGreen,
            [PerceptualHueFamily.YellowGreen, PerceptualHueFamily.Green], PerceptualRoleSet.Chromatic,
            0.64, 0.82, 0.14, 0.23, 132, 148, 419),
        Define("professional-pea-green", ProfessionalColorTerm.PeaGreen,
            UiStrings.ColorPickerProfessionalPeaGreen,
            [PerceptualHueFamily.OliveGreen, PerceptualHueFamily.YellowGreen], PerceptualRoleSet.Chromatic,
            0.63, 0.85, 0.105, 0.19, 112, 130, 417),
        Define("professional-burnt-orange", ProfessionalColorTerm.BurntOrange,
            UiStrings.ColorPickerProfessionalBurntOrange,
            [
                PerceptualHueFamily.Brown, PerceptualHueFamily.Terracotta, PerceptualHueFamily.RedOrange,
                PerceptualHueFamily.Orange
            ],
            PerceptualRoleSet.Chromatic, 0.55, 0.69, 0.115, 0.195, 44, 55, 414),
        Define("professional-straw", ProfessionalColorTerm.Straw, UiStrings.ColorPickerProfessionalStraw,
            [PerceptualHueFamily.Beige, PerceptualHueFamily.Yellow], PerceptualRoleSet.Chromatic,
            0.80, 0.91, 0.085, 0.115, 88, 104, 404),
        Define("professional-paynes-gray", ProfessionalColorTerm.PaynesGray,
            UiStrings.ColorPickerProfessionalPaynesGray,
            [PerceptualHueFamily.BlueGray, PerceptualHueFamily.CoolGray],
            PerceptualRoleSet.Chromatic | PerceptualRoleSet.TintedNeutral,
            0.43, 0.59, 0.022, 0.055, 239, 255, 399),
