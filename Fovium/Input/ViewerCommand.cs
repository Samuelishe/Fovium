...
internal static class ViewerCommands
{
    ...
    [
        ...
        new(ViewerCommand.ToggleSlideshow, "viewer.toggleSlideshow", ViewerCommandGroup.Viewing),
        ...
        new(ViewerCommand.ClosePhoto, "viewer.closePhoto", ViewerCommandGroup.Application),
        ...
        new(
            ...
            ViewerCommandGroup.Presentation,
            ViewerCommandScope.Highlight),
        new(ViewerCommand.SelectHandTool, "viewer.markupTool.hand", ViewerCommandGroup.Markup,
            ViewerCommandScope.Markup),
        new(ViewerCommand.SelectBrushTool, "viewer.markupTool.brush", ViewerCommandGroup.Markup,
            ViewerCommandScope.Markup),
        new(ViewerCommand.SelectEraserTool, "viewer.markupTool.eraser", ViewerCommandGroup.Markup,
            ViewerCommandScope.Markup),
        new(ViewerCommand.SelectLineTool, "viewer.markupTool.line", ViewerCommandGroup.Markup,
            ViewerCommandScope.Markup),
        new(ViewerCommand.SelectRectangleTool, "viewer.markupTool.rectangle", ViewerCommandGroup.Markup,
            ViewerCommandScope.Markup),
        new(ViewerCommand.SelectEllipseTool, "viewer.markupTool.ellipse", ViewerCommandGroup.Markup,
            ViewerCommandScope.Markup),
        new(ViewerCommand.SelectArrowTool, "viewer.markupTool.arrow", ViewerCommandGroup.Markup,
            ViewerCommandScope.Markup),
        new(
